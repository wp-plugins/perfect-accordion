...
Perfect Accordion plugin.

== Description ==

This plugin will enable Accordion With Custom Post Support in your wordpress theme. You can embed Accordion via shortcode in everywhere you want, even in theme files. 
